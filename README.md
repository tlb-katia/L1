...
1. [Самый эффективный способ конкатенации строк](#самый-эффективный-способ-конкатенации-строк)
2. [Интерфейсы и их применение в Go](#интерфейсы-и-их-применение-в-go)
3. [Различия между RWMutex и Mutex](#различия-между-rwmutex-и-mutex)
4. [Буферизированные и не буферизированные каналы](#буферизированные-и-не-буферизированные-каналы)
5. [Размер структуры `struct{}{}`](#размер-структуры-struct)
6. [Отсутствие перегрузки методов и операторов в Go](#отсутствие-перегрузки-методов-и-операторов-в-go)
7. [Последовательность вывода элементов map[int]int](#последовательность-вывода-элементов-mapintint)
8. [Разница между make и new](#разница-между-make-и-new)
9. [Способы задания переменных типа slice или map](#способы-задания-переменных-типа-slice-или-map)
10. [Анализ программы с изменением указателя внутри функции](#анализ-программы-с-изменением-указателя-внутри-функции)
11. [Анализ программы с использованием sync.WaitGroup в горутинах](#анализ-программы-с-использованием-syncwaitgroup-в-горутинах)
12. [Анализ программы с теневым затенением переменных](#анализ-программы-с-теневым-затенением-переменных)
13. [Анализ программы с изменением среза внутри функции](#анализ-программы-с-изменением-среза-внутри-функции)
14. [Анализ программы с анонимной функцией и изменением среза](#анализ-программы-с-анонимной-функцией-и-изменением-среза)
